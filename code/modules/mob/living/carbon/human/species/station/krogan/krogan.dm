/*/datum/species/krogan //Don't activate until everything is worked out.
	name = SPECIES_KROGAN
	name_plural = "Krogan"
	...
	brute_mod = 0.75
	fall_mod = 1.2
	radiation_mod = 0.3 // how else did they survive nuclear armageddon? //Even more radiation resistance, because they're tough bastards.
	grab_mod = 1.25 // Huge, usually have horns
	resist_mod = 2.5 // Arguably our strongest organic species

	ethanol_resistance = 3 //Krogan alcohol melts other Species's organs.
	taste_sensitivity = TASTE_DULL
	economic_modifier = 0.5 //Krogans don't get paid much.
	...
	else.They prefer warmer temperatures than most species." //Get the lore team to do a full description for the Krogan.
	...
	possible_cultures = list(
		...
		/singleton/origin_item/culture/dominian_unathi //Got to rework these with new cultures at some point. Probably clans.
	)
