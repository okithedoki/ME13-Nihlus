/datum/species/unathi
	...
	brute_mod = 0.8
	fall_mod = 1.2
	radiation_mod = 0.9 // Their homeworld is irradiated, what is radiation damage?
	grab_mod = 1.0 // Not too much bigger than normal
	resist_mod = 1.25 // Bit hard, but not too much stronger than a human
	...
	stamina	=	120			  // Turians can hit that burst of speed
	stamina_recovery = 5
